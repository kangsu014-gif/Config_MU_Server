...
function GrowLancerShiningPeak_Level1(InDamage, Strength, Dexterity)
...
-- SkillID: 391, Ice Storm Strengthener - (Gran Master)
function Ice_Storm_Strengthener(InDamage, Energy)
	local OutDamage = InDamage * (Energy / 10 + 200) / 100
	
	return OutDamage
end

-- SkillID: 393, Ice Storm Mastery - (Gran Master)
function Ice_Storm_Mastery(InDamage, Energy)
	local OutDamage = InDamage * (Energy / 10 + 200) / 100
